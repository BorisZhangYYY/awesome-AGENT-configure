...
本项目是一个模板项目，存放一些适用于 AGENT 的模板配置和一些实用场景，目的是希望通过 Harness 和 Loop 手段，让 AI AGENT 更加可靠。
...
- 设计模板时，要基于实际的 AGENT 框架进行，如果不了解则需要调研官方文档，本地安装的有 openclaw，其目录在 `/usr/lib/node_modules/openclaw/docs/`
